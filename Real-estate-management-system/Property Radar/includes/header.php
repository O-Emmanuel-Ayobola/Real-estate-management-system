            ...
            <nav id="primary-menu" class="navbar navbar-fixed-top">
                ...
                <span class="icon-bar"></span>
                 ...
                 <a class="logo" href="index.php">
                    <strong style="color:#34495e; font-size:18px;">Property Radar (PR)</strong>
                </a>
                    </div>
                                                    ...
                                                    <div class="tab-pane fade in active" id="login">
                                                        <div class="signup-form-container text-center">
                                                            <form class="mb-0" method="post" name="signin">
                                                                ...
                                                                <div class="or-text">
                                                                <span style="color: blue">Property Radar (PR)</span>
                                                            </div>
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <input type="radio" name="usertype" value="1" checked="true">Owner &nbsp; &nbsp;<input type="radio" name="usertype" value="3" >User &nbsp; &nbsp;
                                                            </div>
